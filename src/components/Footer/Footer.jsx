...
function Footer() {
  return (
    <section class="relative overflow-hidden bg-black border-t-2 border-gray-700 py-8">
          ...
          <div class="w-auto p-8">
            <a href="#">
              <div class="inline-flex items-center">
                ...
                <span class="text-lg pt-5 font-bold text-white ">
                  TreeTopTales
                </span>
              </div>
            </a>
          ...
          <div class="w-auto p-8">
            <div class="flex flex-wrap">
              <div class="w-auto p-1.5">
                <a href="#">
                  <div class="flex h-8 w-8 items-center justify-center rounded-full border bg-white hover:bg-purple-400  border-gray-300 hover:border-gray-400">
                    <svg
                      width="8"
                      height="14"
                      viewBox="0 0 8 14"
